...
* High quality products: "Everything fails, all the time" (Werner Vogels), and "Site Reliability Engineering (SRE) is what you get when you treat operations as if it's a software problem" ([Google's Site Reliability Engineering](https://landing.google.com/sre/))
