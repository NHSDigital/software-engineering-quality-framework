...
* More **things to monitor**.
  * Monitor (and generate alerts for) the expiry dates of the SSL certificates within the service. See [acm-cert-monitor](../tools/acm-cert-monitor/README.md) for an example lambda and Terraform stack to monitor your AWS ACM certificates.
